const CACHE="astro-image-now-v1.14.0";
const FILES=["./","./index.html","./providers.js","./vendor/astronomy.browser.min.js","./data/targets.js","./filters.js","./forecast-model.js","./journal.js","./advisor.js","./night-plan.js","./equipment.js","./planner.js","./planner-ui.js","./data/solar-system.js","./opportunities.js","./site-forecasts.js","./theme.css","./data/README.md","./data/OpenNGC-LICENSE.txt","./vendor/astronomy-LICENSE.txt","./app.js","./manifest.webmanifest","./icon.svg","./icon-180.png","./icon-192.png","./icon-512.png"];
